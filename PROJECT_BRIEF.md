...
| **M01** | **Multi-Source Character Content Expansion** | 插入式 Maintenance Phase：多來源 Content Pack、PHB/SCAG/GoS/VGM/VRGR/XGE/TCE 角色內容與既有 Character 系統強化；C 後插 M02，再由 D 接續；K補 PHB Feats/Spells，後續內容可再拆 Subphase，final closeout後才回 P2 |
...
| **`待決事項.md`** | 真正無法從既有規格推導、且會影響核心玩法或產品方向的未決問題：已確立前提、選項與代價、與規格的衝突、決定時機 |
