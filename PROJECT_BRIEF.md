...
| P4 | Quick Combat | 第一個完整可玩的 Combat MVP；**A～F 已完成拆分與三份正式文件；P4-A、P4-B、P4-C 已於 2026-09-15、P4-D 於 2026-09-16 關門並合併回 `main`，P4-E 於 2026-09-17 關門（待合併），每個 Subphase 各自合併；下一步 P4-F** |
