...
最後更新：2026-09-17（P4-E — Quick Combat UI, DM Adjudication & AI Tool Surface 關門；P4-D、P4-C、P4-B、P4-A、U01-A 已關門）
...
1. **產品主線：P4-F — Full P4 Integration & Closeout，開工前先拆 F-A、F-B… Subphase**：實作規格 P4-F 1～11 之外，P4-E closeout 的「已知限制」全部歸 P4-F 或 M01：Monster reveal / position note 修改與 DM bookkeeping UI（實作規格 P4-E 7 只到部分）、browser 層的 spell cast / AoE / reaction journey、`ConditionSemantics` 接進 attack / save modifier pipeline、Monster 0 HP outcome action、`grappled` escape、Character state PATCH DTO 的 P4-D 欄位、真實 ChatGPT Web Combat journey（測試指南 F.3）。
