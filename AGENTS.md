...
- **目前階段**：**P0 與 P1 已完成並關門。M01-A～M01-C 已完成，M01 依 Roadmap 暫停；目前進行 M02 — Traditional Chinese / English Localization，M02-A～M02-D 已完成並關門，下一個可開工 Subphase 是 M02-E。M02 closeout 後回到 M01-D～M01-J，最後才回到 P2 — Room / Campaign / Session / Seat 的規劃。**
