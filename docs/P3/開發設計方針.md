...
可用能力：`table_runtime`、`roll`、`ai_actor` 或更精簡一致的 `table`；但 MCP endpoint不可漏 server channel gate。

Standalone：不mount P3 routers、不mount `/mcp`、capability false。
