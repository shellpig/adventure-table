...
23. AI DM disconnect不會自動 End Session，也不讓 Owner或另一 AI token接管；Owner仍只有既有 Abandon escape hatch。（2026-09-20 M05-A 修訂：Owner 對 **AI DM** 的 active Session 另可正常 End，仍不構成接管；見 `docs/M05/實作規格.md` 2.1。）
