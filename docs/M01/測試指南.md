...
| 10.12 Human smoke | 未由真人執行；O-E2E-01 / 02 / 05 / 06 已用真實瀏覽器走過三類代表 Feat 的 disabled reason、choice 順序、Review 與 Sheet 呈現，見 `M01-O_CLOSEOUT.md` |
