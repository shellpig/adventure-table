...
- **最近已驗證 commit**：`78bfc0b5`（G2a code；指揮者完成 Docker E2E、frontend、code quality 與 diff 審核）。
- **下一步**：G2b-1 延續 Adventure journey，完成 Exploration narration／Player action 與 formal Check／roll；由 agy 實作，指揮者審核驗證。
...
| G2b-1 | Adventure journey：Exploration／formal Check | 待做 | G2a | [G2b-1](P6-G_steps/G2b-1.md) |
| G2b-2 | Adventure journey：Quick Combat | 待做 | G2b-1 | [G2b-2](P6-G_steps/G2b-2.md) |
