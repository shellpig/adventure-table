...
- **最近已驗證 commit**：`73a2ee9a`（P6-F closeout；P6-G 尚無 code commit）。
- **下一步**：G1a 空 Campaign 從 Start 到 formal Check／Player roll 的 browser journey；由 agy 實作，指揮者審核驗證。
...
| Step | 標題 | 狀態 | 依賴 | 紀錄 |
|---|---|---|---|---|
| G1a | Empty Campaign：Start、narration、Quick Add、Exploration、Check／roll | 待做 | P6-F | [G1a](P6-G_steps/G1a.md) |
| G1b | Empty Campaign：Quick Combat、world change、End／next Session | 待做 | G1a | [G1b](P6-G_steps/G1b.md) |
...
| G3a | PostgreSQL restart／reconnect continuity | 待做 | G1b／G2b | [G3a](P6-G_steps/G3a.md) |
