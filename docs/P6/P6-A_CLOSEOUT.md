...
| A.1 world / gameplay service 不得改 finalized Adventure | `test_p6a_campaign_adventures.py::test_adventure_domain_has_no_gameplay_actor_entry_point`（P6-A 當時 Adventure service 只接受 `RoomAccessContext`；P6-F 後續允許 current AI DM 透過 Importer author draft，仍拒絕 table actor 修改 finalized Adventure，見 [P6-F closeout](P6-F_CLOSEOUT.md)） |
