...
- **下一步**：B3 已完成；B4 依 route surface 拆為 B4a～B4d，下一步為 B4a — Session 外 Runtime entry REST routes
- **阻礙／未審**：無
...
| B4a | Session 外 Runtime entry REST routes | 待做 | B2c-2 | [B4a](P6-B_steps/B4a.md) |
