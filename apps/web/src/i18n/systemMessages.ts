...
const REQUEST_CODE_MESSAGES: Record<string, Record<Locale, string>> = {
  ...
  character_in_active_session: { 'zh-TW': '此角色目前正在進行中的跑團使用中；請由本場 DM 或目前玩家席位控制者操作，封存則需等跑團結束。', en: 'This Character is in an active Session. Use the current Session DM or Player Seat controller for live edits, and end the Session before archiving.' },
