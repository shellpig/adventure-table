...
const BUILDER_ISSUE_MESSAGES: Record<string, LocalizedMessage> = {
  ...
  race_variant_race_mismatch: { 'zh-TW': '目前選擇的血統變體不屬於所選種族。', en: 'The selected ancestry variant does not belong to the selected race.' },
  ...
  level_up_origin_changed: { 'zh-TW': '升級不能修改種族、血統／亞種、背景或陣營；請改用重建或修正流程。', en: 'Level Up cannot rewrite race, ancestry/subrace, background or alignment. Use Build Edit or Correction.' },
...
const REQUEST_CODE_MESSAGES: Record<string, Record<Locale, string>> = {
  ...
  character_in_active_session: { 'zh-TW': '此角色目前正在進行中的 Session 使用中；請由本場 DM 或目前 Player Seat 控制者操作，封存則需等 Session 結束。', en: 'This Character is in an active Session. Use the current Session DM or Player Seat controller for live edits, and end the Session before archiving.' },
