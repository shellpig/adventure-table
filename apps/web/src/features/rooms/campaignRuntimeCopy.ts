...
const COPY = {
  ...
  'zh-TW': {
    changesTitle: '戰役變更',
    changesIntro: '檢視此戰役的動態世界項目、冒險覆寫與目前情境。',
    backCampaign: '← 回戰役',
    loading: '正在載入戰役變更…',
    ...
    requestFailed: '戰役世界狀態請求失敗。',
    errCampaignRuntimeForbidden: '您沒有在此戰役管理世界狀態的權限。',
    errCampaignRuntimeNotFound: '找不到指定的執行期項目、覆寫或戰役。',
    errCampaignRuntimeArchived: '此執行期項目或戰役已封存，無法修改。',
    errCampaignRuntimeActiveSession: '目前已有進行中的跑團，請透過進行中的跑團進行世界狀態變更。',
    errCampaignRuntimeSessionNotActive: '本場跑團目前非進行中或已結束。',
    errCampaignRuntimeIdempotencyConflict: '此請求索引鍵先前已以不同參數處理過。',
    errCampaignRuntimeRevisionConflict: '世界狀態已被其他動作修改，請重新整理後再試一次。',
    errCampaignRuntimeOverrideExists: '此冒險資料包已存在覆寫。',
    ...
    noCharactersAvailable: '無可用的房間角色',
    dmNotesLabel: 'DM 備忘',
    needsReviewLabel: '待審核',
    needsReviewBadge: '待審核',
    provenanceJsonLabel: '來源資訊 JSON',
    sourceAdventureEntryLabel: '來源冒險資料包 ID',
    readOnlyProvenance: '來源冒險資料包',
    revisionLabel: '修訂版號',
    kindScene: '場景',
    kindNpc: 'NPC',
    kindItem: '物品',
    ...
    noAttachedAdventures: '此戰役尚未附加任何冒險故事。',
    adventureEntriesCountLabel: '資料包數',
    noActiveOverride: '無使用中覆寫（使用原始範本）',
    activeOverrideNotice: '使用中覆寫',
    sessionWorldHeading: '戰役世界狀態',
    sessionWorldIntro: '在這場進行中的跑團追蹤目前場景、情境摘要，並快速新增世界項目。',
    quickAddHeading: '快速新增世界項目',
    quickAddButton: '快速新增',
    refreshingFromEvents: '已儲存；等待跑團事件重新整理…',
    loadError: '載入戰役世界狀態失敗。',
    eventRefreshError: '依跑團事件重新整理世界狀態失敗。',
    retryButton: '重試',
    ...
    journalAccessUnavailable: '本場跑團目前無法存取玩家日誌。',
    ...
    stageImageGroupAdventure: '冒險資料包圖片',
    stageImageGroupRuntime: '執行期項目圖片',
    stageImageGroupRoom: '房間圖片',
