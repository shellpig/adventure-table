...
const copy = {
  'zh-TW': {
    ...
    send: '送出',
    sending: '送出中…',
    composerPlaceholder: '輸入內容；也可使用 /action、/search、/whisper、/ooc。',
    checkDeferred: '/check 需要由 DM 正式要求檢定；目前不會自動擲骰。',
    subjectRequired: '角色對話與行動必須先選擇本場 Player Seat。',
    dicePlaceholder: '正式檢定與骰子流程會在後續 Roll 功能提供；目前不會自動擲骰。',
    dmProxy: 'DM 代理',
  ...
  en: {
    ...
    send: 'Send',
    sending: 'Sending…',
    composerPlaceholder: 'Type here; /action, /search, /whisper, and /ooc are also supported.',
    checkDeferred: '/check requires a formal DM check request; it does not auto-roll here.',
    subjectRequired: 'Character Dialogue and Action require an explicit Player Seat.',
    dicePlaceholder: 'Formal checks and dice arrive with the Roll flow; nothing auto-rolls here.',
    dmProxy: 'DM proxy',
