...
app.include_router(characters_router)  # P2-A compatibility; P2-B removes Web-global Character routes.
app.include_router(character_builder_router)  # P2-A compatibility; P2-B scopes Builder to Room.
