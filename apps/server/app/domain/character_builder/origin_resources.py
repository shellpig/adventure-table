...
def feature_resource_capacities(
    ...
    """Return deterministic live-resource capacities declared by Build features.

    M01-D only needs fixed capacities. Recharge metadata remains on the content
    feature for future Rest workflows; this helper intentionally does not perform
    any recharge or action-economy behavior.
    """
