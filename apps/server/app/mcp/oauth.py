...
def _authorize_page(
    ...
    *,
    ...
    instruction = (
        "請貼上 Adventure Table 產生的 AI Join Token。此頁只會把既有 Seat 授權給目前的 AI agent connector。"
        if zh
        else "Paste the AI Join Token generated by Adventure Table. This only authorizes the existing Seat for this AI agent connector."
    )
    label = "AI Join Token"
