...
@pytest.mark.parametrize(
    ...
    (
        ...
        (_stored_request(request_type="skill", action_kind="shove_prone"), "shove"),
        (_stored_request(request_type="skill", action_kind="shove_push"), "shove"),
        (_stored_request(request_type="skill", action_kind="escape_grapple"), "escape_grapple"),
        (_stored_request(request_type="skill", label="Grapple"), "grapple"),
        (_stored_request(request_type="skill", label="Shove Prone"), "shove"),
        (_stored_request(request_type="skill", label="Shove Push"), "shove"),
        (_stored_request(request_type="skill", label="Escape Grapple"), "escape_grapple"),
