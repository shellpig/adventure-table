...
NON_REF_BUILD_FIELDS = frozenset(
    {
        ...
        "feat_static_facts",
        "feat_static_facts.casting_ability",
        "feat_static_facts.category",
        "feat_static_facts.grants_reply",
        "feat_static_facts.kind",
        "feat_static_facts.range_ft",
        "feat_static_facts.requires_shared_language",
        "feat_static_facts.requires_visible_target",
...
NON_REF_STATE_FIELDS = frozenset(
    {
        ...
        "temporary_effects",
        "temporary_effects.duration",
        "temporary_effects.effect_id",
        "temporary_effects.modifiers",
        "temporary_effects.modifiers.mode",
        "temporary_effects.modifiers.scope",
        "temporary_effects.modifiers.target",
        "temporary_effects.modifiers.value",
        "temporary_effects.note",
        "temporary_effects.tag",
        "temporary_hp",
    }
)
