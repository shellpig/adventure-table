...
5. **AI 是正式桌上 Actor**：AI 可以是 DM 或 Player，但權限由 Role 決定，不因 Controller 是 AI 而變成另一套規則。
...
最多約 6 人。Compact 顯示：HP、可選 AC、Condition icons、Combat Action / Bonus / Reaction。
...
明確排除：玩家私人記事本、DM 私人記事本、Wiki、Campaign 百科、NPC 關係圖、玩家 ToDo、自動整理筆記。玩家／DM 自己記。
...
Build：Class、Base stats、Features、Spellbook、Max resources。

Current State：Current HP、Current Slots、Prepared Spells、Concentration、Conditions、Consumables。
...
End Combat 清：Initiative、Round、Current Turn、Action / Bonus / Reaction、Movement bookkeeping、Surprise、Ready Action、combat-only temp bookkeeping。

保留：HP、Slots / resources、Persistent conditions、Concentration、Inventory、Death state、Monster/NPC outcomes、Map / World State。
...
目前沒有需要在本檔中保留的已知重大待決產品題目。原 handoff 中的 Party Roster / Character 加入退出已由本文件第三章正式定案。
