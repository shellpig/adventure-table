...
**單機版已出貨（M03）。** 同一份 Character Workshop / Builder / Sheet / Level Up / Version History 另以 Windows portable zip 形式離線執行，資料存在執行檔同層的 SQLite，不含 Room / Campaign / Session / Seat 與任何多人功能。角色以 JSON 在網頁版與單機版之間往返；該 JSON schema 在 P2 lock 之前維持 `unstable`。
