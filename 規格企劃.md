...
2026-09-19 P6 額外拍板：Adventure 同時承擔冒險模組與世界／Lore 資料包，不另建 Setting 類型；Campaign 可零到多個 Adventure；沒有 Adventure 仍可直接跑；Current Scene／Situation optional；AI DM 可直接維護 Runtime，`needs_review` 不阻塞；P6 圖片／地圖只作 Stage 素材、不偷跑 Tactical geometry；重要 world mutation 與 definitive narration 不得彼此失真。
